...
<head>
    ...
    <title><spring:message code="msg.orders"/></title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="responsive-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/cart"><spring:message code="msg.cart"/><span
...
<div class="container">
    <div class="row">
        <h3><spring:message code="msg.orders"/></h3>
    </div>
</div>
...
<div class="container">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <spring:message code="msg.username"/>: ${order.user.userName}<br>
                                    <spring:message code="msg.registrationDate"/>: ${order.registrationDate}<br>
                                    <spring:message code="order.status"/>: ${order.status}<br>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <c:forEach items="${order.items}" var="item">
                                        <spring:message code="car.make"/>: ${item.car.make}<br>
                                        <spring:message code="car.model"/>: ${item.car.model}<br>
                                        <spring:message code="car.price"/>: ${item.car.price}<br>
                                        <spring:message code="car.year"/>: ${item.car.year}<br>
                                        <spring:message code="car.condition"/>: ${item.car.condition}<br>
                                        <spring:message code="car.description"/>: ${item.car.description}<br>
                                        <spring:message code="msg.count"/>: ${item.count}<br>
                                        <hr>
                                    </c:forEach>
                                </div>
                            </div>
            ...
            <div class="col-md-4 col-lg-3">
                <sec:authorize access="hasRole('ROLE_ADMIN')">
                    <div id="adminControls">
                        <a href="/admin/order">
                            <spring:message code="msg.showAllOrders"/>
                        </a>
                    </div>
                </sec:authorize>
    ...
    <div class="container" id="footer">
        ...
        <div class="text-center center-block">
            ...
            <a href="https://plus.google.com/116724968968879958223"><i
